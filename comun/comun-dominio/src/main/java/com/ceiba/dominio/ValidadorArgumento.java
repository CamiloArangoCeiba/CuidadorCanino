...
public class ValidadorArgumento {
    ...
    public static void validarMenor(LocalTime horaInicial, LocalTime horaFinal, String mensaje) {
    ...
    public static void validarMenorNoIgual(LocalTime horaInicial, LocalTime horaFinal, String mensaje) {
